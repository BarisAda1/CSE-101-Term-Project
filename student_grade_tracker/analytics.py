def calculate_average(notbooklet, settings, course_id, student_id):
    if course_id not in notbooklet or student_id not in notbooklet[course_id]:
        return 0.0 #starting grade value
    student_grades = notbooklet[course_id][student_id]
